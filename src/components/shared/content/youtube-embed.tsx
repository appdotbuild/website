...
function YouTubeEmbed({
  ...
  return (
    ...
    >
      <button
        className="w-full rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-blue"
        role="button"
      ...
      >
        ...
        <div
          className="absolute left-4 top-4 flex h-8 items-center justify-center gap-x-2 rounded-full bg-background px-3 text-xs font-semibold tracking-tight shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue lg:left-6 lg:top-6 lg:pl-3 lg:pr-4"
