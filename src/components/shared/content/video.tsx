      ...
      {isInView && (
        <LazyMotion features={domAnimation}>
          <AnimatePresence>
            <m.div
              className={cn(
                'relative col-span-full row-span-full flex w-full',
                    ...
                    {(isTouchDevice || showControls) && (
                      ...
                      >
                        <MediaControlBar className="h-12 w-full overflow-hidden rounded-lg border border-border bg-popover px-1 shadow-[0_0.25rem_0.625rem_0rem_hsla(var(--background)/.2)] md:px-2.5">
                          ...
                          <MediaTimeDisplay className="outline-hidden min-w-10 px-0 tracking-tight md:min-w-12" />
                          <MediaTimeRange className="outline-hidden px-1 md:px-2.5" />
                          <MediaDurationDisplay className="outline-hidden min-w-12 px-0 tracking-tight" />
                          <MediaMuteButton className="outline-hidden px-1 md:px-2.5">
                            <span slot="low">
                          ...
                          <MediaVolumeRange className="outline-hidden hidden max-w-[5.375rem] pr-1.5 sm:block" />
